        ...
        <div style={{ flexBasis: "70%", background: "#fff", color: "#000" }}>
          ...
          <div style={{ overflow: "scroll", height: "60vh", padding: "20px" }}>
            <div style={{ fontSize: "24px", ...alegreya_Sans }}>
              ...
              <br />
              <br />
              <span style={{ fontSize: "3rem", ...alegreya_Sans_bold }}>
                TOY DAPP
              </span>
              <br />
              <br />
              At Doge Sound Club (DSC), we also develop Toy Decentralized
              Applications (Toy DApps) to make blockchain technology more
              accessible and enjoyable for everyone, regardless of their
              knowledge about the blockchain. These playful dApps may not have
              specific utility, but they provide a fun, engaging experience for
              users.
              <br />
              <br />
              One of our popular Toy DApps is the Doge Sound Contest. This
              competition combines blockchain technology with a Discord bot to
              host a monthly contest where participants submit their best
              &quot;Doge Sound&quot; entries. Doge Sound refers to nonsensical
              jokes and sayings, known as &quot;Gaesori&quot; in Korean. DSC
              community members vote for the most illogical and unpredictable
              submissions to select a winner.
              <br />
              <br />
              The winning Doge Sound is then showcased on the main page of our
              website. Winners also have the opportunity to mint their Doge
              Sound as an NFT by clicking a button connected to the smart
              contract.
              <br />
              <br />
              The idea behind hosting this unique contest is rooted in our
              project&apos;s fiction. The DSC community believes that the world
              is a simulation, and that inconsistent or unpredictable sayings
              and actions often cause bugs in the simulation. These bugs serve
              as clues that the world is a simulation. To encourage the
              discovery and exploration of these bugs, we&apos;ve been running
              the Doge Sound Contest on the Klaytn blockchain since 2021.
              <br />
              <br />
              By developing and promoting Toy DApps like the Doge Sound Contest,
              DSC aims to create a fun and inclusive environment for users to
              engage with blockchain technology, fostering curiosity and
              ...
              everyone can be a creator, unrestricted by licensing barriers or
              other limitations. We aim to make it easy for ordinary people to
              express their creativity and contribute to a shared universe of
              stories and experiences.
              <br />
              <br />
              To learn more about the Doge Sound Club, our team, and our various
              NFT offerings, please visit our website and join our vibrant
              community.
              <br />
              <br />
            </div>
