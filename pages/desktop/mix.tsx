            ...
            <MainLayout>
                <div style={{ display: "flex" }}>
                    <SidebarLeft></SidebarLeft>
                        <div style={{ width: "70%", height: "100vh", background: "#ffffff", color: "#000000", overflow: "scroll", fontFamily: "Sunflower" }}>
                            <img src="/pc/mix/top.png" style={{ width: "100%" }}/>
                            <p style={{ fontSize: "28px", color: "#36B167", textDecorationLine: "underline" }}>MIX, the future of DSC</p>
                            ...
                            <p style={{ fontSize: "28px", color: "#36B167", textDecorationLine: "underline" }}>MIX pool</p>
                            ...
                            <p style={{ fontSize: "28px", color: "#36B167", textDecorationLine: "underline" }}>Governance</p>
                            <p style={{ fontSize: "20px", margin: "10px 0" }}>We use our own Governance tool(bot) &gt;&gt;&gt; Snapshot.org</p>
                            <p style={{ fontSize: "28px", color: "#36B167", textDecorationLine: "underline" }}>MIX MARKETPLACE</p>
                            <img src="/pc/mix/bottom.png" style={{ width: "100%"}}/>
                        </div>
